...
var Angular2TokenService = /** @class */ (function () {
    ...
    function (url, options) {
        var response = this.http.get(this.getApiPath() + url, options);
        this.handleResponse(response);
        return response;
    };
    Angular2TokenService.prototype.post = function (url, body, options) {
        var response = this.http.post(this.getApiPath() + url, body, options);
        this.handleResponse(response);
        return response;
    };
    Angular2TokenService.prototype.put = function (url, body, options) {
        var response = this.http.put(this.getApiPath() + url, body, options);
        this.handleResponse(response);
        return response;
    };
    Angular2TokenService.prototype.delete = function (url, options) {
        var response = this.http.delete(this.getApiPath() + url, options);
        this.handleResponse(response);
        return response;
    };
    Angular2TokenService.prototype.patch = function (url, body, options) {
        var response = this.http.patch(this.getApiPath() + url, body, options);
        this.handleResponse(response);
        return response;
    };
    Angular2TokenService.prototype.head = function (url, options) {
        var response = this.http.head(this.getApiPath() + url, options);
        this.handleResponse(response);
        return response;
    };
    Angular2TokenService.prototype.options = function (url, options) {
        var response = this.http.options(this.getApiPath() + url, options);
        this.handleResponse(response);
        return response;
    };
    Angular2TokenService.prototype.setCurrentAuthHeaders = function () {
        var _this = this;
